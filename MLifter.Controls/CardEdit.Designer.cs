...
namespace MLifter.Controls
{
    partial class CardEdit
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.audioRecordControl2 = new MLifter.Controls.AudioRecordControl();
            ...
            this.audioRecordControl1 = new MLifter.Controls.AudioRecordControl();
            ...
            // groupBoxAnswer
            // 
            this.groupBoxAnswer.Controls.Add(this.audioRecordControl2);
            ...
            this.groupBoxAnswer.Enter += new System.EventHandler(this.groupBoxAnswer_Enter);
            // 
            // audioRecordControl2
            // 
            resources.ApplyResources(this.audioRecordControl2, "audioRecordControl2");
            this.audioRecordControl2.Name = "audioRecordControl2";
            this.audioRecordControl2.RecordPath = "";
            this.audioRecordControl2.Load += new System.EventHandler(this.audioRecordControl2_Load);
            // 
            ...
            // textColumnQuestion
            // 
            this.textColumnQuestion.IsTextTrimmed = false;
            resources.ApplyResources(this.textColumnQuestion, "textColumnQuestion");
            // 
            // groupBoxQuestion
            // 
            this.groupBoxQuestion.Controls.Add(this.audioRecordControl1);
            ...
            // audioRecordControl1
            // 
            resources.ApplyResources(this.audioRecordControl1, "audioRecordControl1");
            this.audioRecordControl1.Name = "audioRecordControl1";
            this.audioRecordControl1.RecordPath = "";
            this.audioRecordControl1.Load += new System.EventHandler(this.audioRecordControl1_Load);
            // 
            ...
            this.Name = "CardEdit";
            this.Load += new System.EventHandler(this.CardEdit_Load);
        ...
        private AudioRecordControl audioRecordControl1;
        private AudioRecordControl audioRecordControl2;
    }
}
