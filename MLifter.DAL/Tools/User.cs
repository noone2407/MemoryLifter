	...
	public class User : IUser
	{
		...
		public void CheckConnection(ConnectionStringStruct connectionString)
		{
			if (!dbConnectionValid && connectionString.Typ != DatabaseType.Xml)
			{
                ...
                IDbConnection iDbcon = connectionString.Typ == DatabaseType.PostgreSQL ? PostgreSQLConn.CreateConnection(user) as IDbConnection : MSSQLCEConn.GetConnection(user) as IDbConnection;
                DbConnection con = iDbcon as DbConnection;
